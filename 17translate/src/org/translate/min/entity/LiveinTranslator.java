...
public class LiveinTranslator  implements java.io.Serializable {
    ...
    /** full constructor */
    public LiveinTranslator(String luserName, String lpassword, String lmailBox, String lphoneNumber, byte[] lphoto, String lselfDescription, Integer lfans, Integer ltranslationCoin, Integer liveinType, float transExperience, String qualifyDescription, String resumeName, Date liveinDate, float liveinSpan, String translationLevel, Set goodAtFields, Set goodAtLanguages, Set translationArranges) {
        this.luserName = luserName;
        this.lpassword = lpassword;
        this.lmailBox = lmailBox;
