...
<html>
 ...
 <%
	...
	List<MyTranslate> freetranslate = (ArrayList<MyTranslate>)session.getAttribute("freetranslate");
	
	if(freetranslate == null)
		freetranslate = new ArrayList<MyTranslate>();
 %>
  </head>
    		...
    		<div class="two_parttwo">
    			<b class="b1"></b><b class="b2 d1"></b><b class="b3 d1"></b><b class="b4 d1"></b>
				 <div class="b d1 k">
				 	...
				 	<%
				 		for(MyTranslate mt : freetranslate)
				 		{
				 			MyTranslateId mtid = mt.getId();
				 	 %>
				 	
				 		<div class="draftitem" >
							<div id="drafttitle">
								<span class="word2"><a href="#"><%=mtid.getFinishedTitle() %></a></span>
								<span class="word2" style="margin-right: 10px;font-size:12px;float: right">提交时间：<span style="color:green"><%=mtid.getFinishedDate() %></span></span>
							</div>
							<div id="draftinfo">
								<span class="word2" style="font-size:12px">原文语言：<span style="color:green"><%=mtid.getOriginLanguage() %></span></span>
								<span class="word2" style="font-size:12px">目标语言：<span style="color:green"><%=mtid.getOriginLanguage() %></span></span>
							</div>
				 		</div>
