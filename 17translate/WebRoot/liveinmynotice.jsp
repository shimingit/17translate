...
<%
	...
	List<Notice> liveinnotice = (ArrayList<Notice>)session.getAttribute("liveinnotice");
	
	if(null == liveinnotice)
		liveinnotice = new ArrayList<Notice>();
 %>
  </head>
    		...
    		<div class="two_parttwo">
    			<b class="b1"></b><b class="b2 d1"></b><b class="b3 d1"></b><b class="b4 d1"></b>
				 <div class="b d1 k">
				 	...
				 	<%
				 		for(Notice notice : liveinnotice)
				 		{	
				 	 %>
				 		<div class="draftitem" >
							<div id="drafttitle">
